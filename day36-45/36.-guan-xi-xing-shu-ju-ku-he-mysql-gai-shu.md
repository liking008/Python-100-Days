...
4.  ER模型（实体关系模型）和概念模型图。
    ...
    * 重数 - 1:1（一对一） / 1:N（一对多） / M:N（多对多）
    ...
    ![](../.gitbook/assets/conceptual_model.png)
5. 关系数据库产品。
   ...
   * [PostgreSQL](36.-guan-xi-xing-shu-ju-ku-he-mysql-gai-shu.md) - 在 BSD 许可证下发行的开放源代码的关系数据库产品。
...
1.  通过[官方网站](https://www.mysql.com/)提供的[下载链接](https://dev.mysql.com/downloads/windows/installer/8.0.html)下载“MySQL社区版服务器”安装程序，如下图所示，建议大家下载离线安装版的MySQL Installer。
    ...
    ![](../.gitbook/assets/20211105230905.png)
2.  运行 Installer，按照下面的步骤进行安装。

    * 选择自定义安装。

    ![](../.gitbook/assets/20211105231152.jpg)

    * 选择需要安装的组件。

    ![](../.gitbook/assets/20211105231255.jpg)

    * 如果缺少依赖项，需要先安装依赖项。

    ![](../.gitbook/assets/20211105231620.png)

    * 准备开始安装。

    ![](../.gitbook/assets/20211105231719.jpg)

    * 安装完成。

    ![](../.gitbook/assets/20211105232024.jpg)

    * 准备执行配置向导。

    ![](../.gitbook/assets/20211105231815.jpg)
3.  执行安装后的配置向导。

    * 配置服务器类型和网络。

    ![](../.gitbook/assets/20211105232109.jpg)

    *   配置认证方法（保护密码的方式）。

        ![](../.gitbook/assets/20211105232408.jpg)
    *   配置用户和角色。

        ![](../.gitbook/assets/20211105232521.jpg)
    *   配置Windows服务名以及是否开机自启。

        ![](../.gitbook/assets/20211105232608.jpg)
    *   配置日志。

        ![](../.gitbook/assets/20211105232641.jpg)
    *   配置高级选项。

        ![ACAC15B8633133B65476286A49BFBD7E](../.gitbook/assets/20211105232724.jpg)
    *   应用配置。

        ![](../.gitbook/assets/20211105232800.jpg)
4.  可以在 Windows 系统的“服务”窗口中启动或停止 MySQL。

    ![](../.gitbook/assets/20211105232926.jpg)
5. 配置 PATH 环境变量，以便在命令行提示符窗口使用 MySQL 客户端工具。
   *   打开 Windows 的“系统”窗口并点击“高级系统设置”。

       ![](../.gitbook/assets/20211105233054.jpg)
   *   在“系统属性”的“高级”窗口，点击“环境变量”按钮。

       ![](../.gitbook/assets/20211105233312.jpg)
   *   修改PATH环境变量，将MySQL安装路径下的`bin`文件夹的路径配置到PATH环境变量中。

       ![](../.gitbook/assets/20211105233359.jpg)
   *   配置完成后，可以尝试在“命令提示符”下使用 MySQL 的命令行工具。

       ![](../.gitbook/assets/20211105233643.jpg)
